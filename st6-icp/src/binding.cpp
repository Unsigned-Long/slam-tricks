...
int main(int argc, char const *argv[]) {
  auto writer1 = ns_csv::CSVWriter::create("../log/binding/pc1.csv");
  auto writer2 = ns_csv::CSVWriter::create("../log/binding/pc2.csv");
  auto writer3 = ns_csv::CSVWriter::create("../log/binding/pc1_prime_2.csv");
  // pre
  ...
  // solve
  auto T21_est = ns_st6::icp(pc1, pc2, 2);
  // transfrom
